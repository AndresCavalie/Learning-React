...
function SearchBar(props) {
    ...
    return (
        <div className="container">
            <div className="row"><h2 className="red">Search for an Item</h2></div>
            <div className="row">
            ...
            <div className="row mt-3"><div className="col-4" /> <button className="col-4 btn btn-primary" type="button" onClick={searchButtonPressed}>Search</button>
            </div>
